...
export default function GatePass() {
  ...
  const handleSubmit = async () => {
    if (!formData.escorterName || !formData.escorterMobile || !formData.wardenName || !formData.imageURL) {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="bg-gradient-to-b from-red-600 via-orange-500 to-yellow-400 text-white py-6 px-4 sm:px-8 flex flex-col">
        ...
        <h1 className="text-2xl sm:text-3xl font-bold">Out Pass</h1>
                      ...
                      <div className="sm:col-span-2">
                        ...
                        {pass.imageURL && (
                          <a href={pass.imageURL} target="_blank" rel="noopener noreferrer" className="inline-block mt-2">
                            <img src={pass.imageURL} alt="Escorter" className="h-24 w-24 rounded-full object-cover border-2 border-gray-200" />
                          </a>
                        )}
                      </div>
                    </div>
