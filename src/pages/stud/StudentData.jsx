    ...
    <div className="p-4">
      ...
      {loading ? (
        ...
        <div className="space-y-4">
          ...
          {Object.entries(groupStudentsByCampus()).map(
            ([campus, campusStudents], index, array) => (
              <div
                key={campus}
                ...
                >
                  ...
                  <svg
                    className={`h-5 w-5 text-gray-500 transform transition-transform ${
                      expandedCampuses[campus] ? "rotate-180" : ""
                    }`}
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                      ...
                      <div className="flex flex-wrap gap-4 mb-4">
                        ...
                        <div className="relative flex-1 min-w-[200px]">
                          <input
                            ...
                            onChange={(e) =>
                              handleSearchChange(campus, e.target.value)
                            }
                          />
                          <svg
                        ...
                        <div className="flex-1 min-w-[200px]">
                          <select
                            ...
                            onChange={(e) =>
                              handleSectionFilterChange(campus, e.target.value)
                            }
                          >
