...
import { FaFileAlt, FaBook, FaChartBar, FaChartPie, FaCalendarAlt } from 'react-icons/fa';
    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-8">
      ...
      <div className="bg-gradient-to-br from-red-600 via-orange-500 to-yellow-400 text-white rounded-lg p-6 mb-6 shadow-md">
        ...
        <h1 className="text-2xl md:text-3xl font-bold mb-2">
          {studentData?.student?.name || studentData?.studentName || 'Student'}'s Reports
        </h1>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-screen overflow-y-auto">
            <div className="p-6">
              ...
              <div className={`bg-gradient-to-r from-blue-50 to-blue-100 border-l-4 border-blue-500 p-4 mb-6 rounded-r-lg shadow-sm`}>
