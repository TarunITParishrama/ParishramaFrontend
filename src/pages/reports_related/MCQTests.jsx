...
export default function MCQTests({
  ...
  const [isDetailedReportSubmitted, setIsDetailedReportSubmitted] =
    useState(false);
  ...
  const loadTestResults = async (testName) => {
    try {
      ...
      checkDetailedReportStatus(testName);
    } catch (err) {
  ...
  const checkDetailedReportStatus = async (testName) => {
    if (!testName) return;

    try {
      setCheckingDetailedReport(true);
  ...
  const submitDetailedReport = async () => {
    ...
    try {
      ...
      setIsDetailedReportSubmitted(true);
          ...
          <div className="flex justify-between items-center p-4 border-b">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                disabled={
                  submitLoading ||
                  checkingDetailedReport ||
                  isDetailedReportSubmitted
                }
